...
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
     ...
     * @var string
     */
    const ASSET_REMOTE_URL = 'https://use.fontawesome.com/releases/v5.0.13/css/all.css';

    /**
     * @var string
     */
    const ASSET_LOCAL_URL = 'Swissup_FontAwesome::fontawesome-free-5.0.13/web-fonts-with-css/css/fontawesome-all.min.css';
